...
namespace Organisationstool.Models.Controllers.Admin
{
    ...
    public class A_VeranstaltungController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IWebHostEnvironment _hostingEnvironment;

        public A_VeranstaltungController(IUnitOfWork unitOfWork, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public IActionResult DeletePOST(int? id)
        {
            ...
            var mitwirkenden = _unitOfWork.Mitwirkender.GetAll(u => u.VeranstaltungId == id);
            foreach (var mitwirkende in mitwirkenden)
            {
                mitwirkende.VeranstaltungId = null;
            }
