...
function loadDataTable() {
    dataTable = $('#tblData',).DataTable({
        ...
        "columns": [
            { "data": "name", "width": "15%" },
            { "data": "email", "width": "15%" },
            { "data": "passwort", "width": "15%" },
            {
                data: 'id',
                "render": function (data) {
                    return `<div class="w-75 btn-group" role="group">
                     <a href="/AOrganisator/upsert?id=${data}" class="btn btn-success mx-2"> <i class="bi bi-pencil-square"></i>Berabeiten</a>               
                     <a onClick=Delete('/AOrganisator/delete/${data}') class="btn btn-danger mx-2"> <i class="bi bi-trash-fill"></i>Löschen</a>
                    </div>`
                },
                "width": "25%"
            }
