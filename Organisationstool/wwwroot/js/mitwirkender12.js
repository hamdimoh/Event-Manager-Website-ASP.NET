...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        ...
        "columns": [
            ...
            { data: 'veranstaltung.namederVeranstaltung', "width": "15%" },
            {
                data: 'id',
                "render": function (data) {
                    return `<div class="w-75 btn-group" role="group">
                     <a href="/A_Mitwirkende/upsert?id=${data}" class="btn btn-success mx-2"> <i class="bi bi-pencil-square"></i> Bearbeiten</a>               
                     <a onClick=Delete('/A_Mitwirkende/delete/${data}') class="btn btn-danger mx-2"> <i class="bi bi-trash-fill"></i> Löschen</a>
                    </div>`
                },
                "width": "20%"
            }
