            ...
            { data: 'veranstaltung.namederVeranstaltung', "width": "10%" },
            {
                ...
                "render": function (data) {
                    return `<div class="w-75 btn-group" role="group">
                     <a href="/AGast/upsert?id=${data}" class="btn btn-success mx-2"> <i class="bi bi-pencil-square"></i> Bearbeiten</a>               
                     <a onClick=Delete('/AGast/delete/${data}') class="btn btn-danger mx-2"> <i class="bi bi-trash-fill"></i> Löschen</a>
                    </div>`
                },
                "width": "25%"
            }
