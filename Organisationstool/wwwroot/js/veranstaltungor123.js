...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        "ajax": { url: '/O_Veranstaltung/getall' },
        "language":
        {
           ...
           
            {
                ...
                "render": function (data) {
                    return `<div class="w-75 btn-group" role="group">
                     <a href="/O_Veranstaltung/upsert?id=${data}" class="btn btn-success mx-2"> <i class="bi bi-pencil-square"></i>Bearbeiten</a>               
                     <a onClick=Delete('/O_Veranstaltung/delete/${data}') class="btn btn-danger mx-2"> <i class="bi bi-trash-fill"></i>Löschen</a>
                    </div>`
                },
                "width": "15%"
            }
