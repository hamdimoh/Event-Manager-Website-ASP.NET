...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        "ajax": { url: '/A_Veranstaltung/getall' },
        "language":
        {
        ...
        "columns": [
            { data: 'namederVeranstaltung', "width": "25%" },
            { data: 'adresse', "width": "10%" },
            { data: 'nrgäste', "width": "10%" },
            { data: 'nrMit', "width": "5%" },
            { data: 'budget', "width": "10%" },
            { data: 'aufgaben', "width": "10%" },
            { data: 'essen', "width": "10%" },
            { data: 'bild', "width": "10%" },
           
            {
                ...
                "render": function (data) {
                    return `<div class="w-75 btn-group" role="group">
                     <a href="/A_Veranstaltung/upsert?id=${data}" class="btn btn-success mx-2"> <i class="bi bi-pencil-square"></i>Bearbeiten</a>               
                     <a onClick=Delete('/A_Veranstaltung/delete/${data}') class="btn btn-danger mx-2"> <i class="bi bi-trash-fill"></i>Löschen</a>
                    </div>`
                },
                "width": "15%"
            }
